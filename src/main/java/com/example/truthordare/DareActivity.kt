...
class DareActivity : AppCompatActivity() {
    ...
    private fun loadSavedState() {
        ...
        // 获取已使用计数
        usedCount = prefs.getInt("dare_used_count", 0)

        // 获取已使用题目列表
        val usedQuestionsJson = prefs.getString("dare_used_questions", null)
        ...
        // 获取上次题目
        lastQuestion = prefs.getString("dare_last_question", null)
    ...
    private fun saveState() {
        ...
        // 保存已使用计数
        editor.putInt("dare_used_count", usedCount)

        // 保存已使用题目列表
        val usedQuestionsJson = Gson().toJson(usedQuestions)
        editor.putString("dare_used_questions", usedQuestionsJson)

        // 保存上次题目
        editor.putString("dare_last_question", lastQuestion)
