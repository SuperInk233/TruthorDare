...
class LoveTruthActivity : AppCompatActivity() {
    ...
    private var truthQuestions = mutableListOf<String>()

    companion object {
        private const val PREFS_NAME = "love_truth_prefs"
        private const val KEY_USED_COUNT = "love_truth_used_count"
        private const val KEY_USED_QUESTIONS = "love_truth_used_questions"
        private const val KEY_LAST_QUESTION = "love_truth_last_question"
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_love_truth)
        ...
        truthQuestions = QuestionRepository.getLoveTruthQuestions(this).toMutableList()
    ...
    private fun extractQuestion() {
        val available = truthQuestions.filter { it !in usedQuestions && it != lastQuestion }
    ...
    private fun updateCounter() {
        val remaining = truthQuestions.size - usedCount
