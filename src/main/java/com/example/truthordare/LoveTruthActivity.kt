...
class LoveTruthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ★★★★★ 从仓库获取题库，不强制重置 ★★★★★
        truthQuestions = QuestionRepository.getLoveTruthQuestions(this)
    ...
    private fun startQuestionScrolling() {
        ...
        scrollRunnable = object : Runnable {
            override fun run() {
                if (isScrolling) {
                    questionTextView.text = truthQuestions.random()
                    scrollCount++
    ...
    private fun stopScrollingAndShowResult() {
        ...
        usedCount++
        saveHistory(finalQuestion, "心动真心话")
        saveState()
        updateCounter()
    ...
    private fun updateCounter() {
        counterTextView.text = "$usedCount/${truthQuestions.size}"
    }
